...
export default function Demo() {
  ...
  return (
    <div className="max-w bg-gray-950 h-1/2 ">
          <h1 className="text-white text-center text-4xl ">Pomodoro timer</h1>
          <div className="flex">
          <div className="w-1/3 p-8">
                <h1 className="text-white text-center ">TIMER 1</h1>
          </div>
          <div className="w-1/3 p-8">
          <h1 className="text-white text-center ">TIMER 2</h1>
          <Timer/>
          <button
    ...
    >
      ...
      >
        ...
        />
          ...
          <div className="w-1/3 p-8 ">
          <h1 className="text-white text-center ">TIMER 3</h1>
          <ContextoConfiguracion.Provider value={{
            mostrarConfiguracion,
            SetmostrarConfiguracion,
            minutosTrabajo:minutosTrabajo,
